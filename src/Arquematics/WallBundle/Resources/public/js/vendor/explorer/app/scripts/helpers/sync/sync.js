...
define([
...
], function (_, $, Removed,  arSyncNotes) {
    'use strict';
    ...
    */
    ...
    function Sync (collection) {
        ...
        switch (collection.storeName) {
            case 'notes':
                this.cloud = arSyncNotes.sync;
                break;
            case 'remotestorage':
                this.cloud = RemoteSync;
                break;
            case 'alcoor':
                this.cloud = AlcoorSync;
                break;
        }
    ...
    Sync.prototype = {
        ...
        localNeedsUpdate: function (model) {
            ...
            // User removed it locally
                ...
                //el modelo de momento solo tiene la id
                // y la fecha
                $.when( this.cloud('read', model) )
                    .done(function (m) {
                      model.set(m);
