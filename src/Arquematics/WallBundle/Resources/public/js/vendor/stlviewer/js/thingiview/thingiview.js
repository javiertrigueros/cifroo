Thingiview = function(containerId, contentDocument, thingiurlbase) {
  ...
  var windowHalfX = contentDocument.window.innerWidth / 2;
  var windowHalfY = contentDocument.window.innerHeight / 2
  ...
  this.initScene = function() {
    ...
    contentDocument.window.addEventListener('mousemove',      onRendererMouseMove,     false);    
    ...
    contentDocument.window.addEventListener('mouseup',        onRendererMouseUp,       false);
    ...
    worker.onmessage = function(event) {
      if (event.data.status == "complete") {
        ...
        for (i in event.data.content[0]) {
          var vector = new THREE.Vector3( event.data.content[0][i][0], event.data.content[0][i][1], event.data.content[0][i][2] );
