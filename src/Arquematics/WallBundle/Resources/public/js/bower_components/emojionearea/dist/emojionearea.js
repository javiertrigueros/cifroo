...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        var sourceValFunc = source.is("TEXTAREA") || source.is("INPUT") ? "val" : "text",
            ...
            button = self.button = div('button',
                div('button-file cmd-file'),
                div('button-open'),
                div('button-close'),
                div('button-file-extra hide cmd-file-extra'),
                div('button-twitter hide cmd-twiter cmd-network-select-buttom disabled'),
                div('button-facebook hide cmd-facebook cmd-network-select-buttom disabled'),
                div('button-linkedin hide cmd-linkedin cmd-network-select-buttom disabled')        
        ...
        .on("@!paste", function(editor, event) {
            ...
            var pasteText = function(text) {
                ...
                self.pasteHtmlAtCaret('<i id="' + caretID +'"></i>');
            ...
            self.pasteHtmlAtCaret('<span>' + invisibleChar + '</span>');
        ...
        .on("@emojibtn.click", function(emojibtn) {
            ...
            if (self.standalone) {
                ...
                self.pasteHtmlAtCaret(shortnameTo(emojibtn.data("name"), self.emojiTemplate));
            }
    ...
    var EmojioneArea = function(element, options) {
		var self = this;
                self.pasteHtmlAtCaret = pasteHtmlAtCaret;
