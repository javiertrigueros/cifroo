 ...
 * Class WallMessage
 *
 * @ORM\Table(name="ArFileChunk")
 * @ORM\Entity(repositoryClass="Arquematics\WallBundle\Entity\ArFileChunkRepository")
 */
class ArFileChunk implements JsonSerializable
{
    /**
     * @var integer
     *
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\Arquematics\WallBundle\Entity\ArFile", inversedBy="arFileChunks")
